...
{
    public abstract class DK_JobTGoalWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DK_JobTGoalWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DK_JobTGoalWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DK_JobTGoalDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DK_JobTGoalDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DK_JobTGoalDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DK_JobTGoalDbContext, Task<T>> func)
        {
            T result;

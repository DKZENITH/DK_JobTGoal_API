...
namespace DK_JobTGoal.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = DK_JobTGoalConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(DK_JobTGoalDbContext context)
        {
            _context = context;
        }
